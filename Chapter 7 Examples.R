...
#plot graph with X indicating predicting value
mower.df <- read.csv("~/R/Datasets/RidingMowers.csv")
set.seed(111)
...
# classify new household using the best K = 4
