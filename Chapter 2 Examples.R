...
# TAKING PARTS USING ARRAY
housing.df <- read.csv("~/R/Datasets/WestRoxbury.csv", header = TRUE) # load data
...
reg
dim(train.data$TOTAL_VALUE)
dim(reg$fitted.values)
train.data[1:10, ]
...
# regression model to predict validation set
